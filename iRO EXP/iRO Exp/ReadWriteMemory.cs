...
namespace ReadWriteMemory
{
    public class ProcessMemory
    {
        ...
        public int ProcessHandle { get { return processHandle; } }
        public Process Process { get { return MyProcess[processIndex]; } }

        // Methods
        public ProcessMemory(string pProcessName, int processIndex)
        {
        ...
        {
            ProcessModuleCollection modules = this.MyProcess[processIndex].Modules;
        ...
        {
            this.BaseAddress = 0;
            this.myProcessModule = this.MyProcess[processIndex].MainModule;
        ...
        public bool StartProcess()
        {
            if (this.ProcessName != "")
            {
                ...
                this.processHandle = OpenProcess(2035711, false, this.MyProcess[processIndex].Id);
